namespace Commodore.GameLogic.Core
{
    public class SystemMemoryAddresses
    {
        ...
        public const int __reservedE = 0x000021;                        // byte
        public const int __reservedF = 0x000022;                        // byte
        public const int __reservedG = 0x000023;                        // byte
        public const int __reservedH = 0x000024;                        // dword
        public const int __reservedI = 0x000028;                        // dword
