...
namespace Commodore.GameLogic.Executive.CodeEditor
{
    public partial class Editor
    {
        ...
        public Editor(TrueTypeFont font)
        {
            ...
            new Bindings.FileSystem(this);
            new Bindings.Modification(this);
            new Bindings.Navigation(this);
            new Bindings.StatusControl(this);
        }
        ...
        private void DrawLineHighlight(RenderContext context)
        {
            context.Rectangle(
                ShapeMode.Fill,
                new Vector2(
                    Window.Margins.Left * TextRenderer.HorizontalGranularity,
                    Cursor.Y
                ),
        ...
        public void UpdateCursorPosition()
        {
            Cursor.SetGranularPosition(
                Buffer.CursorX + Window.Margins.Left,
                Buffer.CursorY + Window.Margins.Top
            );
        }
        ...
        public Vector2 CalculateLinePosition(int index)
        {
            return new Vector2(
                Window.Margins.Left * TextRenderer.HorizontalGranularity,
                (Window.Margins.Top * TextRenderer.VerticalGranularity) + (index * TextRenderer.VerticalGranularity)
            );
        }
    }
}
